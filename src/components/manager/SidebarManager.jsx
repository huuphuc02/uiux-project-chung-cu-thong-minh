      ...
      <div className="bg-white flex flex-col gap-16 w-full items-start pt-4 pb-4">
        <div className="flex flex-col gap-6 items-start">
          ...
          >
            ...
            >
              <path
                d="M28 31.2236C32.7229 31.2236 36.5516 26.9804 36.5516 21.7461C36.5516 16.5118 32.7229 12.2686 28 12.2686C23.277 12.2686 19.4484 16.5118 19.4484 21.7461C19.4484 26.9804 23.277 31.2236 28 31.2236Z"
                stroke="#A3A0A0"
                strokeWidth="5"
              />
              <path
                d="M51.3401 18.3793C52.4467 19.8683 53 20.6126 53 21.7461C53 22.8796 52.4467 23.6239 51.3401 25.1128C47.2921 30.5599 38.3636 40.7012 28 40.7012C17.6362 40.7012 8.70771 30.5599 4.6597 25.1128C3.55323 23.6239 3 22.8796 3 21.7461C3 20.6126 3.55323 19.8683 4.6597 18.3793C8.70771 12.9324 17.6362 2.79102 28 2.79102C38.3636 2.79102 47.2921 12.9324 51.3401 18.3793Z"
                stroke="#A3A0A0"
                strokeWidth="5"
              />
            </svg>

            <span className="font-semibold ">Xem khoản thu</span>
          </div>
          <div
            className={
              tab == "Thống kê"
