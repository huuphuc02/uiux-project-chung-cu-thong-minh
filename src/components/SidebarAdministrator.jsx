      ...
      <div id="NewRootRoot" className="flex flex-row w-[20%] items-start">
        <div className="bg-white flex flex-col gap-16 w-full items-start pt-4 pb-4">
            <div className="flex flex-col gap-6 items-start">
              <div className="bg-[#99b7f0] items-center flex flex-row gap-6 w-full h-16 px-4 cursor-pointer" onClick={() => navigate("/homepageAdmin")}>
                <img
              ...
              <div className="flex flex-row px-4 gap-6 items-center py-4 cursor-pointer w-full hover:bg-[#99b7f0] hover:text-white" onClick={() => navigate("/SendNotifications")}>
                <img
            ...
            <div className="flex flex-row gap-6 items-center cursor-pointer px-4 py-4 w-full hover:bg-[#99b7f0]" onClick={() => navigate("/Statistics")}>
              <img
            ...
            <div className="flex flex-row gap-4 items-center cursor-pointer w-full px-4 hover:bg-[#99b7f0]" onClick={() => navigate("/setting")}>
              <img
