            ...
            <div className="flex flex-col justify-between gap-5 w-full items-start">
              ...
              <div className="flex flex-col gap-4 w-full items-start">
                ...
                <div className="flex flex-row justify-between w-full items-start">
                  ...
                  <textarea className="text-[#a6a6a6] shadow-[0px_4px_4px_0px_rgba(0,_0,_0,_0.25)] bg-white flex flex-row w-1/2 h-16 items-start px-4"></textarea>
                </div>
              </div>
              <div className="flex flex-row ml-[510px] gap-8 w-1/3 items-start">
                ...
                <button
                  ...
                  onClick={() => {
                    alert(
                      "Đăng ký tạm vắng thành công!. Đơn đăng ký của bạn sẽ được gửi công an phê duyệt."
                    );
                    navigate("/residenceAbsence");
                  }}
                >
