    ...
    <div className="h-screen">
      ...
      <div className="flex">
        ...
        <div id="NewRootRoot" className="flex flex-row w-[82%] items-start">
          <div className="bg-[#f5f5f5] ml-2 flex flex-col w-full font-['Nunito_Sans'] items-start pt-4 pb-4">
            ...
            <div className=" flex flex-col gap-6 w-full h-max items-start">
